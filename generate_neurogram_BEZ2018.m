function [neurogram_ft,neurogram_mr,t_ft,t_mr,CFs] = generate_neurogram_BEZ2018(stim,Fs_stim,species,ag_fs,ag_dbloss)
...
for CFlp = 1:numcfs
    ...
    for spontlp = 1:sum(numsponts)
        ...
        psth_ft = model_Synapse_BEZ2018(vihc,CF,nrep,1/Fs,noiseType,implnt,spont,tabs,trel);
